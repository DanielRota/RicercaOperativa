...
namespace RicercaOperativa
{
    public partial class RicercaOperativa : Form
    {
        ...
        private void VogelMethod()
        {
            ...
            mainDataGridView.Columns["Discard"].DefaultCellStyle.BackColor = Color.LightCyan;
            mainDataGridView.RowTemplate.Height = 25;
            mainDataGridView.Rows[mainDataGridView.RowCount - 1].DefaultCellStyle.BackColor = Color.LightCyan;
